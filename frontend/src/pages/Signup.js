...
function Signup() {
	...
	async function uploadImage() {
		...
		try {
			...
			let res = await fetch(`https://api.cloudinary.com/v1_1/${cloudinary_cloud_name}/upload`, {
				method: 'post',
				body: data
			});
				...
				<Col md={7} className="d-flex align-items-center justify-content-center flex-direction-column">
					<Form style={{ width: "80%", maxWidth: 500 }} onSubmit={handleSignup}>
						...
						<div className='signup-profile-pic__container'>
							<img src={imagePreview || profileImage} className='signup-profile-pic' alt='' />
						...
						<Button variant="primary" type="submit" onSubmit={(e) => handleSignup(e)}>
